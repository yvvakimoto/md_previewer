...
| 拡張記法 | Mermaid / KaTeX / Marp スライド / SmartArt / CSV・TSV テーブル / **外部CSV→Plotly 対話的チャート** / Footnote ツールチップ（標準同梱） | 多くは拡張機能の追加導入が必要 | コアおよびプラグインで対応 | Mermaid / KaTeX 等を内蔵（Marp 非対応） |

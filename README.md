...
サンプル: [samples/短編小説.md](samples/短編小説.md)（書き下ろしの短編、約7ページ）／ [samples/縦書き長文.md](samples/縦書き長文.md)
...
| `短編小説.md` | 書き下ろしの短編小説「校正室の窓」（約7ページ）。`bunko.css` の読み心地・ページ分割を試すための地の文サンプル |

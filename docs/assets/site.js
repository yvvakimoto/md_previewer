...
(function () {
  ...
  var I18N = {
    ...
    'feat.kicker':   { ja: 'EVERYTHING INCLUDED', en: 'EVERYTHING INCLUDED' },
    'feat.title':    { ja: '全部、はじめから入っています。', en: 'All of it, in the box.' },
    'feat.lead':     { ja: 'プラグインの追加も、ネットワークも要りません。すべて本体に入っています。',
                       en: 'No plugins to add and no network to reach. Every renderer ships with the app.' },
    'feat.mermaid':  { ja: 'フロー・シーケンス・ガント', en: 'Flow, sequence, Gantt' },
    'feat.katex':    { ja: 'インライン / ディスプレイ数式', en: 'Inline and display math' },
    'feat.marp':     { ja: '16:9 スライド・PDF 出力', en: '16:9 slides, PDF export' },
    'feat.tikz':     { ja: 'WASM TeX で可換図式', en: 'Commutative diagrams via WASM TeX' },
    'feat.plotly':   { ja: '外部 CSV から対話グラフ', en: 'Interactive charts from a CSV' },
    'feat.csv':      { ja: 'フェンスがそのまま表に', en: 'A fenced block becomes a table' },
    'feat.markwhen': { ja: '年表・カレンダー', en: 'Timelines and calendars' },
    'feat.abc':      { ja: '五線譜のレンダリング', en: 'Rendered staff notation' },
    'feat.rubyT':    { ja: 'ルビ', en: 'Ruby' },
    'feat.ruby':     { ja: '振り仮名・モノルビ', en: 'Group and mono ruby' },
    'feat.tateT':    { ja: '縦書き', en: 'Vertical text' },
    'feat.tate':     { ja: '禁則・縦中横・文庫組み', en: 'Kinsoku, tate-chu-yoko, paperback grid' },
    'feat.tblT':     { ja: '表の往復', en: 'Tables both ways' },
    'feat.tbl':      { ja: 'PowerPoint と相互に貼付', en: 'Paste to and from PowerPoint' },
    'feat.exportT':  { ja: '書き出し', en: 'Export' },
    'feat.export':   { ja: '単独 HTML / しおり付き PDF', en: 'One-file HTML, bookmarked PDF' },
    'feat.themeT':   { ja: 'テーマ', en: 'Themes' },
    'feat.theme':    { ja: 'CSS を 1 枚置くだけ', en: 'Drop in a single CSS file' },
    'feat.wsT':      { ja: 'ワークスペース', en: 'Workspaces' },
    'feat.ws':       { ja: 'フォルダをツリーで', en: 'A folder, as a file tree' },
    'feat.vidT':     { ja: '動画', en: 'Video' },
    'feat.vid':      { ja: 'ローカル動画・YouTube', en: 'Local files and YouTube' },
    'feat.i18nT':    { ja: '日英 UI', en: 'Bilingual UI' },
    'feat.i18n':     { ja: '両ウィンドウとも切替可', en: 'Both windows, switchable live' },

    'cmp.kicker': { ja: 'WHY ANOTHER ONE', en: 'WHY ANOTHER ONE' },
    'cmp.title':  { ja: '読むためだけに、つくりました。', en: 'Built for reading, first.' },
    'cmp.lead':   { ja: '編集を主役にしたツールは既にたくさんあります。これは「渡された <code>.md</code> を、きれいに読む」ほうに寄せた道具です。',
                    en: 'There is no shortage of editors. This one leans the other way: making a <code>.md</code> someone handed you good to read.' },
    'cmp.h0':     { ja: '観点', en: 'Aspect' },
    'cmp.r1':     { ja: '開きかた', en: 'How you open it' },
    'cmp.r1a':    { ja: '<b><code>.md</code> をダブルクリック</b>', en: '<b>Double-click the <code>.md</code></b>' },
    'cmp.r1b':    { ja: 'アプリ起動 → プレビューを開く', en: 'Launch, then open a preview pane' },
    'cmp.r1c':    { ja: 'vault を開く', en: 'Open a vault' },
    'cmp.r1d':    { ja: 'アプリ起動 → ファイルを開く', en: 'Launch, then open the file' },
    'cmp.r2':     { ja: '主眼', en: 'Centre of gravity' },
    'cmp.r2a':    { ja: '<b>閲覧</b>（編集は <kbd>E</kbd> で）', en: '<b>Reading</b> (edit with <kbd>E</kbd>)' },
    'cmp.r2b':    { ja: 'エディタ', en: 'Editing' },
    'cmp.r2c':    { ja: 'ノート編集', en: 'Note-taking' },
    'cmp.r2d':    { ja: 'WYSIWYG 編集', en: 'WYSIWYG editing' },
    'cmp.r3':     { ja: 'テーマの足しかた', en: 'Adding a theme' },
    'cmp.r3a':    { ja: '<b><code>assets/</code> に CSS を 1 枚</b>', en: '<b>One CSS file in <code>assets/</code></b>' },
    'cmp.r3b':    { ja: '設定ファイルにパスを列挙', en: 'List paths in a settings file' },
    'cmp.r3c':    { ja: 'テーマ導入 / snippets', en: 'Install a theme, or a snippet' },
    'cmp.r3d':    { ja: 'テーマフォルダに配置', en: 'Drop it in the theme folder' },
    'cmp.r4':     { ja: '縦書き・文庫組み', en: 'Vertical / paperback typesetting' },
    'cmp.r5':     { ja: 'Marp スライド', en: 'Marp slides' },
    'cmp.r6':     { ja: 'ライセンス', en: 'Licence' },
    'cmp.r6a':    { ja: '<b>MIT / 無償</b>', en: '<b>MIT, free</b>' },
    'cmp.r6b':    { ja: '無償', en: 'Free' },
    'cmp.r6c':    { ja: '個人無償 / 商用有償', en: 'Free personal, paid commercial' },
    'cmp.r6d':    { ja: '有償', en: 'Paid' },
    'cmp.yes':     { ja: '対応', en: 'Yes' },
    'cmp.no':      { ja: '—', en: '—' },
    'cmp.builtin': { ja: '標準搭載', en: 'Built in' },
    'cmp.ext':     { ja: '拡張機能', en: 'Extension' },
    'cmp.plugin':  { ja: 'プラグイン', en: 'Plugin' },

...
(function () {
  ...
  var I18N = {
    ...
    'cmp.kicker': { ja: 'WHAT IT ADDS', en: 'WHAT IT ADDS' },
    'cmp.title':  { ja: 'Markdown で書けることを、増やしました。', en: 'Widening what Markdown can say.' },
    'cmp.lead':   { ja: '素の Markdown では表せないもの — 縦書きの文庫組み、ルビ、可換図式、楽譜、年表、多段組み — を記法ごと足しています。読むのも書くのも同じ場所で済むよう、<kbd>E</kbd> キーのエディタも Vim・数式入力支援・セルモードまで用意しました。',
                    en: 'Vertical paperback typesetting, ruby, commutative diagrams, staff notation, timelines, multi-column layout — things plain Markdown cannot express, added as notation. And so that reading and writing happen in one place, the editor behind <kbd>E</kbd> goes as far as Vim, math input assist and a cell mode.' },
    'cmp.h0':     { ja: '観点', en: 'Aspect' },
    'cmp.r1':     { ja: '開きかた', en: 'How you open it' },
    'cmp.r1a':    { ja: '<b><code>.md</code> をダブルクリック</b>（関連付けと右クリックメニューをインストーラが登録）',
                    en: '<b>Double-click the <code>.md</code></b> — the installer registers the association and the context menu' },
    'cmp.r1b':    { ja: '関連付け可。表示は <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>V</kbd> でプレビューを開く',
                    en: 'Association works; rendering needs <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>V</kbd>' },
    'cmp.r1c':    { ja: 'vault が前提（単体ファイルは扱いにくい）',
                    en: 'Built around a vault; a loose file is awkward' },
    'cmp.r1d':    { ja: '関連付けでダブルクリック', en: 'Double-click, via the file association' },
    'cmp.r2':     { ja: '拡張記法', en: 'Extended notation' },
    'cmp.r2a':    { ja: '<b>Mermaid・数式・Marp・楽譜・年表・可換図式を標準搭載</b>',
                    en: '<b>Mermaid, math, Marp, staff notation, timelines and commutative diagrams, all built in</b>' },
    'cmp.r2b':    { ja: '多くは拡張機能を追加', en: 'Mostly via extensions' },
    'cmp.r2c':    { ja: 'コアとプラグイン', en: 'Core plus plugins' },
    'cmp.r2d':    { ja: 'Mermaid・数式を内蔵（Marp は非対応）',
                    en: 'Mermaid and math built in; no Marp' },
    'cmp.r3':     { ja: '縦書き・文庫組み・ルビ', en: 'Vertical text, paperback grid, ruby' },
    'cmp.r4':     { ja: 'エディタ', en: 'Editor' },
    'cmp.r4a':    { ja: '<b>内蔵</b>（Vim・数式入力支援・セルモード）',
                    en: '<b>Built in</b> — Vim, math input assist, cell mode' },
    'cmp.r4b':    { ja: '本体がエディタ', en: 'The app is an editor' },
    'cmp.r4c':    { ja: '本体がエディタ', en: 'The app is an editor' },
    'cmp.r4d':    { ja: 'WYSIWYG エディタ', en: 'A WYSIWYG editor' },
    'cmp.r5':     { ja: 'テーマの足しかた', en: 'Adding a theme' },
    'cmp.r5a':    { ja: '<b><code>assets/</code> に CSS を 1 枚</b>', en: '<b>One CSS file in <code>assets/</code></b>' },
    'cmp.r5b':    { ja: '設定ファイルにパスを列挙', en: 'List paths in a settings file' },
    'cmp.r5c':    { ja: 'テーマ導入 / snippets', en: 'Install a theme, or a snippet' },
    'cmp.r5d':    { ja: 'テーマフォルダに配置', en: 'Drop it in the theme folder' },

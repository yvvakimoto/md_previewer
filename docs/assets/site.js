...
(function () {
  ...
  var I18N = {
    ...
    'lib.abcjs':     { ja: 'ABC 記譜法を五線譜に・再生も', en: 'ABC notation as staff notation, with playback' },
    ...
    'gal.abcAlt':    { ja: 'きらきら星の旋律が五線譜に描かれ、下に再生バーが付いたもの',
                       en: 'The tune of Twinkle, Twinkle drawn on a stave, with a playback bar beneath it' },
